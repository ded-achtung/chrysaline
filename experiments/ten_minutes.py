...
TEXTS = [
    ...
    # Учебник: предложение
    "Предложение это слово или несколько слов которые выражают законченную мысль. Слова в предложении связаны между собой по смыслу. Подлежащее это главный член предложения. Сказуемое это главный член предложения.",
    # Учебник: склонения
    "Имя существительное изменяется по падежам и числам. Единственное число используют для обозначения одного предмета. Множественное число используют для обозначения нескольких предметов. Первое склонение относятся существительные мужского и женского рода. Второе склонение объединяет существительные мужского рода. Третье склонение относятся существительные женского рода.",
    # Учебник: состав слова
    "Корень это общая часть однокоренных слов. Приставка это часть слова которая стоит перед корнем. Суффикс это часть слова которая стоит после корня. Окончание это изменяемая часть слова.",
    # Учебник: большая буква
    "С большой буквы пишутся имена отчества фамилии людей клички животных. С большой буквы пишутся названия городов улиц стран морей рек.",
    # Учебник: синонимы антонимы
    "Синонимы это слова которые произносятся по-разному а по смыслу одинаковые. Антонимы это слова противоположные по значению.",
]
